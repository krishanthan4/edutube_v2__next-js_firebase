      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h3 className="text-sm font-medium text-blue-900">Default Categories Available:</h3>
            <p className="text-sm text-blue-700 mt-1">
              Web Development, Cybersecurity, Mobile Development, Computer Science, Backend Development, Frontend Development
            </p>
            <p className="text-xs text-blue-600 mt-2">
              These categories will be shown if no custom categories are created.
            </p>
          </div>
        </div>
      </div>
